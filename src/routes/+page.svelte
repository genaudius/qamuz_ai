  ...
  <div class="container mx-auto relative">
    ...
    >
      ...
      >
        ...
        >
          Dive into endless AI possibilities: chat with top-tier LLMs, generate
          stunning images, videos, and audio from simple prompts, and chain it
          all together with powerful pipelines — your ultimate creative toolkit
          awaits.
        </p>
              ...
              <div>
                ...
                <div class="flex flex-wrap gap-2 mb-4">
                  {#if index === 0}
                    ...
                    >
                    <Badge variant="secondary" class="text-xs">Audio Gen</Badge>
                  {:else if index === 1}
