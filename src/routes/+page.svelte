<script lang="ts">
  ...
  function handleRouteLinkClick(event: MouseEvent, path: string) {
    mobileMenuOpen = false;
  ...
  const features = [
    {
      ...
      title: "90+ Models",
      description:
        "Discover an expansive library of over 90 AI models tailored to your needs — from cutting-edge LLMs for intelligent conversations with branching and Read Aloud support, to a full creative suite of tools for image, video, and audio generation. Connect it all together with pipelines that let you feed AI responses directly into your creative workflow as prompts.",
    ...
    },
    {
      ...
      description:
        "Transform your visions into reality with powerful image and video generation capabilities. Use text-to-image or image-to-image to create and refine stunning visuals, then take it further with video generation — turning written prompts or static assets into dynamic clips, videos, and smooth animations.",
    ...
    },
    {
      ...
      description:
        "Explore a full suite of audio capabilities to enhance any project. Convert text to natural-sounding speech with TTS, transcribe audio back to text with STT, or transform voices in real time with the Voice Changer. Go further by generating original music from prompts or creating custom sound effects to bring your content to life.",
...
{:else}
      ...
      <div class="flex h-16 items-center relative">
        ...
        <div class="ml-auto hidden md:flex items-center gap-2">
          {#if session?.user}
            ...
            <Button
              href={resolve("/newchat")}
              onclick={(event) => handleRouteLinkClick(event, "/newchat")}
          ...
          {:else}
            ...
            <Button
              variant="outline"
              href={resolve("/login")}
              onclick={(event) => handleRouteLinkClick(event, "/login")}
            ...
            <Button
              ...
              onclick={(event) => handleRouteLinkClick(event, "/register")}
    ...
    <div class="container mx-auto relative">
      ...
      >
        ...
        >
          ...
          >
            Dive into endless AI possibilities: chat with top-tier LLMs,
            generate stunning images, videos, and audio from simple prompts, and
            chain it all together with powerful pipelines — your ultimate
            creative toolkit awaits.
          </p>
    ...
    <div class="container mx-auto relative">
      ...
      <div class="text-center mb-10">
        <h2 class="text-2xl sm:text-4xl font-black mb-6 tracking-tight">
          One Platform, Every AI Tool You Need — From Conversation to Creation.
        </h2>
        <p
          class="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed"
        >
          One AI platform for intelligent conversations, stunning visuals, and
              ...
              <div class="space-y-4">
                <div>
                  ...
                  <div class="flex flex-wrap gap-2 mb-4">
                    {#if index === 0}
                      <Badge variant="secondary" class="text-xs">LLMs</Badge>
                      <Badge variant="secondary" class="text-xs"
                        >Image & Video Gen</Badge
                      >
                      <Badge variant="secondary" class="text-xs"
                        >Audio Gen</Badge
                      >
            ...
            >
              ...
              <div class="flex-1 md:px-4">
                <div class="pricing-free-features">
                  {#each freePlan.features as feature (feature)}
          ...
          >
            <Card.Content class="px-8 py-4 text-center h-full flex flex-col">
              ...
              <Button
                ...
                onclick={(event) => handleRouteLinkClick(event, "/pricing")}
              >
                Get Started
              </Button>
            </Card.Content>
        ...
        <Accordion.Root type="single">
          <Accordion.Item value="models">
            ...
            <Accordion.Content class="text-gray-300 text-base">
              ...
              OpenRouter (32+ text models), Google Gemini, OpenAI, xAI,
              Stability AI, Black Forest Labs, Kling AI, Luma Labs, and Alibaba.
              This includes text generation models like Claude, GPT, Gemini, and
              Llama, plus 25+ image generation models and 8+ video generation
              models.
            </Accordion.Content>
          </Accordion.Item>
          ...
          <Accordion.Item value="switching">
            ...
            <Accordion.Content class="text-gray-300 text-base">
              Yes! You can seamlessly switch between any of our 65+ models
              during a conversation while maintaining your complete chat
              history. This allows you to leverage different model strengths for
              different tasks within the same conversation.
            </Accordion.Content>
          </Accordion.Item>
          ...
          <Accordion.Item value="files">
            ...
            <Accordion.Content class="text-gray-300 text-base">
              ...
              use as input for image-to-image and image-to-video generation
          ...
          <Accordion.Item value="security">
            ...
            <Accordion.Content class="text-gray-300 text-base">
              Yes, we prioritize your privacy and security. We're GDPR
              compliant, SOC2 certified, and maintain 99.9% uptime. Your
              conversations and generated content are securely stored with
              enterprise-grade encryption. We include bot protection via
              Cloudflare Turnstile and follow security best practices.
            </Accordion.Content>
          </Accordion.Item>
          ...
          <Accordion.Item value="free-tier">
            ...
            <Accordion.Content class="text-gray-300 text-base">
              ...
              models. It's perfect for trying out the platform and light usage.
  ...
  <footer class="border-t py-8 px-4" style="background-color: #101011">
    <div class="container mx-auto text-center">
      <div
        class="mt-16 pt-8 border-t border-gray-800 text-center text-gray-400"
      >
        <p>
          &copy; {new Date().getFullYear()}
          {settingsState.siteName}. All rights reserved.
        </p>
      </div>
    </div>
  </footer>
