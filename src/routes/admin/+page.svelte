      ...
      <Card.Content>
        <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          <Button
            ...
            onmouseenter={() => warmRoute("/admin/analytics")}
            ontouchstart={() => warmRoute("/admin/analytics")}
          >
          ...
          <Button
            ...
            onmouseenter={() => warmRoute("/admin/users")}
            ontouchstart={() => warmRoute("/admin/users")}
          >
            <div class="text-lg">👥</div>
          ...
          <Button
            ...
            onmouseenter={() => warmRoute("/admin/payments")}
            ontouchstart={() => warmRoute("/admin/payments")}
          >
            <div class="text-lg">💳</div>
          ...
          <Button
            ...
            onmouseenter={() => warmRoute("/admin/subscriptions")}
            ontouchstart={() => warmRoute("/admin/subscriptions")}
          >
            <div class="text-lg">📋</div>
          ...
          <Button
            ...
            ontouchstart={() => warmRoute("/admin/settings")}
          >
