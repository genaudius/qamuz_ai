...
<div class="space-y-4">
  ...
  <div class="flex justify-between items-center">
    ...
    <Button
      ...
      onmouseenter={() => warmRoute("/admin/settings/plans/create")}
      ontouchstart={() => warmRoute("/admin/settings/plans/create")}
    ...
    <Card.Content class="space-y-4">
      {#if data.plans.length === 0}
        <div class="flex flex-col items-center justify-center py-12 space-y-4">
          ...
          <form method="POST" action="?/seedFreePlan">
            <Button type="submit" disabled={data.isDemoMode}>
              {data.isDemoMode ? "Seed Free Plan (Demo)" : "Seed Free Plan"}
            </Button>
          </form>
        ...
        <Table.Root>
          <Table.Header>
            <Table.Row>
              ...
              <Table.Head>Audio Limit</Table.Head>
          ...
          <Table.Body>
            {#each data.plans as plan}
              <Table.Row>
                ...
                <Table.Cell>
                  {formatLimit(plan.audioGenerationLimit)}
                </Table.Cell>
                <Table.Cell>
                ...
                <Table.Cell>
                  <Button
                    ...
                    onmouseenter={() => warmRoute(`/admin/settings/plans/${plan.id}`)}
                    ontouchstart={() => warmRoute(`/admin/settings/plans/${plan.id}`)}
                    disabled={data.isDemoMode}
                  >
