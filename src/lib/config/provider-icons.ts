...
export const providerConfig: Record<string, ProviderIconConfig> = {
	...
	ByteDance: { iconPath: "/ai-provider-icons/bytedance-favicon.png" },
	...
	Nvidia: { iconPath: "/ai-provider-icons/nvidia-favicon.png" },
	Xiaomi: { iconPath: "/ai-provider-icons/xiaomi-favicon.png" },
	StepFun: { iconPath: "/ai-provider-icons/stepfun-favicon.png" }
};